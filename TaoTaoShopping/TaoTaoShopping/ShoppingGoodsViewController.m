...
@interface ShoppingGoodsViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,RequestDelegate,ZBarReaderDelegate,UITextFieldDelegate>
...
{
    ZBarReaderViewController * zvc = [[ZBarReaderViewController alloc] init];
    zvc.readerDelegate = self;
    
    //二维码/条形码识别设置
    ZBarImageScanner *scanner = zvc.scanner;
